  ...
  return (
    <>
      <div className="sign-up-container">
        <Head>
          <title>Sign-Up - AutoSell UI</title>
          <meta property="og:title" content="Sign-Up - AutoSell UI" />
        </Head>
        <div className="SignInUp">
          <div className="sign-up-container02">
            <img src="/frame%20140.svg" alt="image" className="sign-up-image" />
...
function validatePasswords() {
    ...
    message.textContent = 'Passwords are valid!';
}
              ...
              <div className="SignInUpForm">
                <div className="sign-up-title-root">
                  ...
                  <div className="sign-up-have-an-account-login">
                    <p className="sign-up-text01 thq-body-large">
                ...
                <div
                  id="messageContainer"
                  style="display: none;"
                  className="sign-up-container05"
                >
                  <span id="message" className="sign-up-text02">
                    Text
                  </span>
                </div>
                <div className="Form">
                ...
                <div className="sign-up-container11">
                  <button
                    ...
                    type="submit"
                    className="sign-up-button1 thq-button-outline"
                  >
                    <svg
                  ...
                  <button
                    ...
                    type="submit"
                    className="sign-up-button2 thq-button-outline"
                  >
                    <svg
                      viewBox="0 0 860.0137142857142 1024"
                      className="sign-up-icon6"
                    >
                ...
                <div className="sign-up-have-an-account-login1">
                  <p className="SimpleMessage">
                    ...
                    <Link href="/sign-in">
                      <a className="sign-up-link">Sign In</a>
                    </Link>
                  </p>
                </div>
              </div>
        ...
        <img src="/bg.svg" alt="image" className="sign-up-image1" />
      </div>
      <style jsx>
        {`
          .sign-up-container {
