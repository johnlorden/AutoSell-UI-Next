  ...
  return (
    <>
      <div className="marketplace-container">
        <Head>
          <title>Marketplace - AutoSell UI</title>
          <meta property="og:title" content="Marketplace - AutoSell UI" />
        </Head>
        <div className="TopBar">
          <div className="marketplace-container1">
            <img
              alt="image"
            ...
            <img
              ...
              className="marketplace-image1"
            />
            <SearchBar></SearchBar>
          </div>
          <div className="Top TopNav">
            <Link href="/">
              <a className="marketplace-link button">Newsfeed</a>
            </Link>
            ...
            <Link href="/challenges">
              <a className="marketplace-link3 button">Challenges</a>
            </Link>
          </div>
        ...
        <div className="TopNav Bot">
          <Link href="/">
            <a className="marketplace-link4 button">
          ...
          <Link href="/marketplace">
            <a className="marketplace-link5 button ActiveButton">
              <svg viewBox="0 0 1024 1024" className="marketplace-icon02">
          ...
          <button type="button" className="button">
            <svg viewBox="0 0 1024 1024" className="marketplace-icon04">
          ...
          <Link href="/jobs">
            <a className="button">
              <svg viewBox="0 0 1024 1024" className="marketplace-icon06">
          ...
          <Link href="/challenges">
            <a className="marketplace-link7 button">
              <svg viewBox="0 0 1024 1024" className="marketplace-icon08">
