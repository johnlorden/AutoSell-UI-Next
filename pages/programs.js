  ...
  return (
    <>
      <div className="programs-container">
        <Head>
          <title>Programs - AutoSell UI</title>
          <meta property="og:title" content="Programs - AutoSell UI" />
        </Head>
        <div className="TopBar">
          <div className="programs-container1">
            ...
            <img
              ...
              className="programs-image1"
            />
            <SearchBar></SearchBar>
          </div>
          <div className="Top TopNav">
            <Link href="/">
              <a className="programs-link button">Newsfeed</a>
            </Link>
            <Link href="/marketplace">
              <a className="programs-link1 button">Marketplace</a>
            </Link>
            <button type="button" className="button ActiveButton">
              Programs
            </button>
            <Link href="/jobs">
              <a className="programs-link2 button">Jobs</a>
            </Link>
            <Link href="/challenges">
              <a className="programs-link3 button">Challenges</a>
            </Link>
          </div>
        ...
        <div className="programs-container4 TopNav Bot">
          <Link href="/">
            <a className="programs-link4 button">
              <svg viewBox="0 0 1024 1024" className="programs-icon">
          ...
          <Link href="/marketplace">
            <a className="programs-link5 button">
              <svg viewBox="0 0 1024 1024" className="programs-icon02">
          ...
          <button
            type="button"
            className="programs-button1 button ActiveButton"
          >
            <svg viewBox="0 0 1024 1024" className="programs-icon04">
          ...
          <Link href="/jobs">
            <a className="programs-link6 button">
              <svg viewBox="0 0 1024 1024" className="programs-icon06">
          ...
          <Link href="/challenges">
            <a className="programs-link7 button">
              <svg viewBox="0 0 1024 1024" className="programs-icon08">
