      ...
      <div className="jobs-container">
        ...
        <div className="TopBar">
          ...
          <div className="Top TopNav">
            <Link href="/">
              <a className="jobs-link button">Newsfeed</a>
            </Link>
            ...
            <Link href="/challenges">
              <a className="jobs-link3 button">Challenges</a>
            </Link>
          </div>
        ...
        <div className="TopNav Bot">
          ...
          <button type="button" className="jobs-button1 button">
          ...
          <Link href="/jobs">
            <a className="jobs-link6 button ActiveButton">
