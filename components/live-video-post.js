...
const LiveVideoPost = (props) => {
  ...
  return (
    <>
      ...
      <style jsx>
        {`
          .live-video-post-container {
            width: 100%;
          }
          .live-video-post-container1 {
            flex: 0 0 auto;
            width: 100%;
            height: auto;
            display: flex;
          ...
          .live-video-post-button:hover {
            fill: var(--dl-color-theme-neutral-dark);
            color: #ffffff;
            background-color: var(--dl-color-theme-primary2);
          }
          .live-video-post-button:active {
            transform: scale(0.95);
          }
          .live-video-post-container3 {
          ...
          .live-video-post-icon04 {
            width: 24px;
            height: 24px;
          }
          .live-video-post-text02 {
            align-self: center;
          }
          .live-video-post-icon06 {
            width: 24px;
            height: 24px;
          }
          .live-video-post-text03 {
            align-self: center;
          }
          .live-video-post-container6 {
            flex: 1;
            width: 100%;
            height: 100%;
            display: flex;
          ...
          .live-video-post-icon08 {
            width: 24px;
            height: 24px;
          }
          .live-video-post-icon10 {
            width: 24px;
            height: 24px;
          }
        `}
