...
const Account = (props) => {
  const [moreAccountActions, setMoreAccountActions] = useState(false)
      ...
      <div className={`account-container ${props.rootClassName} `}>
        ...
        document.querySelectorAll('[what="subnav"]').forEach(subnav => {
            ...
            subnav.addEventListener('mouseout', function() {
              ...
              >
                ...
                <span className="account-text">Digital Store</span>
              </button>
              <button
              ...
              >
                ...
                <span className="account-text01">Community</span>
              </button>
              <button
                id="Profile-nav-main"
                type="button"
              ...
              >
                ...
                <span className="account-text02">Profile Builder</span>
              </button>
              <button
              ...
              >
                ...
                <span className="account-text03">Testimonials</span>
              </button>
              <button
                id="Webinar-nav-main"
                type="button"
              ...
              >
                ...
                <span className="account-text04">Courses &amp; Webinars</span>
              </button>
              <button
              ...
              >
                ...
                <span className="account-text05">Automate</span>
              </button>
              <button
                id="payment-link-nav-main"
                type="button"
                what="mainnav"
                className="account-button06 mainnavdefault"
              >
                ...
                <span className="account-text06">Payment Links</span>
              </button>
              <button
              ...
              >
                ...
                <span className="account-text07">Refer &amp; Earn</span>
              </button>
              <button
                id="AskAI-nav-main"
                type="button"
              ...
              >
                ...
                <span className="account-text08">Ask Autosell AI</span>
              </button>
            </div>
          )}
        </div>
        <div className="account-container05">
          <div className="account-container06">
            <svg viewBox="0 0 1024 1024" className="account-icon24">
        ...
        {moreAccountActions && (
          <div className="account-container11">
            ...
            <button type="button" className="account-button09 AccountButton">
              <svg viewBox="0 0 1024 1024" className="account-icon28">
                <path d="M938.667 640v-426.667c0-35.328-14.379-67.413-37.504-90.496s-55.168-37.504-90.496-37.504h-597.333c-35.328 0-67.413 14.379-90.496 37.504s-37.504 55.168-37.504 90.496v682.667c0 10.923 4.181 21.845 12.501 30.165 16.683 16.683 43.691 16.683 60.331 0l158.165-158.165h494.336c35.328 0 67.413-14.379 90.496-37.504s37.504-55.168 37.504-90.496zM853.333 640c0 11.776-4.736 22.4-12.501 30.165s-18.389 12.501-30.165 12.501h-512c-11.776 0-22.443 4.779-30.165 12.501l-97.835 97.835v-579.669c0-11.776 4.736-22.4 12.501-30.165s18.389-12.501 30.165-12.501h597.333c11.776 0 22.4 4.736 30.165 12.501s12.501 18.389 12.501 30.165z"></path>
              </svg>
              <span>Messages</span>
            </button>
            <button type="button" className="account-button10 AccountButton">
              <svg viewBox="0 0 1024 1024" className="account-icon30">
                <path d="M725.333 341.333c0 171.136 40.405 278.187 78.976 341.333h-584.619c38.571-63.147 78.976-170.197 78.976-341.333 0-58.923 23.851-112.213 62.464-150.869s91.947-62.464 150.869-62.464 112.213 23.851 150.869 62.464 62.464 91.947 62.464 150.869zM810.667 341.333c0-82.475-33.493-157.184-87.467-211.2s-128.725-87.467-211.2-87.467-157.184 33.493-211.2 87.467-87.467 128.725-87.467 211.2c0 261.419-102.101 343.339-109.355 348.757-19.328 13.141-24.448 39.424-11.477 58.923 8.192 12.245 21.589 18.901 35.499 18.987h768c23.552 0 42.667-19.115 42.667-42.667 0-14.464-7.168-27.221-18.304-35.029-7.509-5.547-109.696-87.467-109.696-348.971zM548.907 874.581c-5.931 10.197-15.317 17.024-25.941 19.84s-22.187 1.579-32.384-4.309c-6.912-4.011-12.075-9.472-15.317-15.232-11.691-20.48-37.717-27.605-58.197-15.915s-27.605 37.717-15.915 58.197c10.667 18.731 26.581 35.115 46.635 46.763 30.549 17.749 65.493 21.376 97.109 12.971s60.117-28.928 77.824-59.477c11.819-20.395 4.864-46.507-15.488-58.325s-46.507-4.864-58.325 15.488z"></path>
              </svg>
              <span>Notification</span>
            </button>
            <button type="button" className="account-button11 AccountButton">
            ...
            <button type="button" className="account-button12 AccountButton">
            ...
            <button type="button" className="account-button13 AccountButton">
              <svg viewBox="0 0 1024 1024" className="account-icon36">
